...
class FlexibleLocalDihedralForceFieldGenerator final : public ForceFieldGeneratorBase
{
  ...
  public:
    ...
    {
        const std::string fld_expression = fmt::format("FLD{id}_k * ("
                "FLD{id}_c +"
                "FLD{id}_kcos1*cos(  theta) +"
                "FLD{id}_ksin1*sin(  theta) +"
                "FLD{id}_kcos2*cos(2*theta) +"
                "FLD{id}_ksin2*sin(2*theta) +"
                "FLD{id}_kcos3*cos(3*theta) +"
                "FLD{id}_ksin3*sin(3*theta)"
        ...
        torsion_ff->addPerTorsionParameter(fmt::format("FLD{}_k", ffgen_id_));
        torsion_ff->addPerTorsionParameter(fmt::format("FLD{}_c", ffgen_id_));
        torsion_ff->addPerTorsionParameter(fmt::format("FLD{}_kcos1", ffgen_id_));
        torsion_ff->addPerTorsionParameter(fmt::format("FLD{}_ksin1", ffgen_id_));
        torsion_ff->addPerTorsionParameter(fmt::format("FLD{}_kcos2", ffgen_id_));
        torsion_ff->addPerTorsionParameter(fmt::format("FLD{}_ksin2", ffgen_id_));
        torsion_ff->addPerTorsionParameter(fmt::format("FLD{}_kcos3", ffgen_id_));
        torsion_ff->addPerTorsionParameter(fmt::format("FLD{}_ksin3", ffgen_id_));
