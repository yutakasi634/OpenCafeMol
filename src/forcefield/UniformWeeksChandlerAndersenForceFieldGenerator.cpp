#include "UniformWeeksChandlerAndersenForceFieldGenerator.hpp"
...
UniformWeeksChandlerAndersenForceFieldGenerator::UniformWeeksChandlerAndersenForceFieldGenerator(
